...
namespace newJSON.Models
{
    public partial class json_app_dbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=tcp:jsondb.database.windows.net,1433;Initial Catalog=json_app_db;Persist Security Info=False;User ID='JSONDB';Password='BIT286JSON!';MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
